 ...
 * @author Wilfred
 */
public class QueryUserGroups implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<HrsGroups> list;
    
    public QueryUserGroups(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading User Groups..");
                ph.start();
                DataAccess da = new DataAccess();
                List<HrsGroups> list = da.searchGroups(sqlString);
                for (HrsGroups e: list){
