 ...
 * @author Wilfred
 */
public class QueryUsers implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<HrsUsers> list;
    ...
    public QueryUsers(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Users..");
                ph.start();
                DataAccess da = new DataAccess();
                List<HrsUsers> list = da.searchUsers(sqlString);
                for (HrsUsers e: list){
